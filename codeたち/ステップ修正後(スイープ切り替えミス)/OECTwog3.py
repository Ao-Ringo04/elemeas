...
class MeasurementController:
    ...
    def _check_vref_reached_with_overshoot(self, target_vref: float, initial_vref: float, 
        ...
        """
        Vrefが目標値に到達、または超過したかを判定（90%以上のサンプルが条件を満たしたら折り返す）
        ...
        【条件2：許容範囲到達】
        - Vrefが target_vref の ±tolerance_percent 以内 で判定
        ...
        # ← target_vref と initial_vref を比較（0ではなく）
        ...
        try:
            for cycle in range(params.cycle_num):
                ...
                while True:
                    ...
                    # 現在地は vref_sat_max_change、目指す先は vref_sat_initial
                    reached, vref_avg, samples = self._check_vref_reached_with_overshoot(
